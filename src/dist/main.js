...
var map = {
	"../app/components/events/events.module": [
...
module.exports = "<nav class=\"navbar navbar-expand-md navbar-dark bg-dark\">\n    <a class=\"navbar-brand\" routerLink=\"/\">Muega-Planner</a>\n    <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarmain\" aria-controls=\"navbarmain\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n      <span class=\"navbar-toggler-icon\"></span>\n    </button>\n\n    <div class=\"collapse navbar-collapse\" id=\"navbarmain\">\n      <ul class=\"navbar-nav mr-auto\">\n        <li class=\"nav-item\">            \n          <a class=\"nav-link\" *ngIf=\"auth.isLoggedIn()\" routerLink=\"/\">Home</a>\n        </li>\n        <li class=\"nav-item\">\n            <a class=\"nav-link\" *ngIf=\"auth.isLoggedIn()\" routerLink=\"/calendars\">Calendars</a>\n          </li>\n      </ul>\n      <!-- <form class=\"form-inline my-2 my-md-0\">\n        <input class=\"form-control\" type=\"text\" placeholder=\"Search\">\n      </form> -->\n      <ul class=\"navbar-nav navbar-right\">\n        <li class=\"nav-item\" *ngIf=\"!auth.isLoggedIn()\"><a class=\"nav-link\" routerLink=\"/login\">Sign in</a></li>\n        <li class=\"nav-item\" *ngIf=\"auth.isLoggedIn()\"><a class=\"nav-link\" routerLink=\"/profile\">{{ auth.getUserDetails()?.name }}</a></li>\n        <li class=\"nav-item\" *ngIf=\"auth.isLoggedIn()\"><a class=\"nav-link\" routerLink=\"\" (click)=\"auth.logout()\">Logout</a></li>\n      </ul>\n    </div>\n  </nav>\n<div class=\"container-fluid\">\n  <div class=\"row\">\n    <div class=\"col\">         \n      <router-outlet></router-outlet>      \n    </div>\n  </div>\n</div>"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_muega_services_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _muega_components_subscribers_subscribers_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @muega-components/subscribers/subscribers.component */ "./src/app/components/subscribers/subscribers.component.ts");
/* harmony import */ var _muega_components_calendar_calendar_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @muega-components/calendar/calendar.component */ "./src/app/components/calendar/calendar.component.ts");
/* harmony import */ var _muega_components_calendars_calendars_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @muega-components/calendars/calendars.component */ "./src/app/components/calendars/calendars.component.ts");
/* harmony import */ var _muega_components_user_profile_profile_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @muega-components/user/profile/profile.component */ "./src/app/components/user/profile/profile.component.ts");
/* harmony import */ var _muega_components_user_login_login_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @muega-components/user/login/login.component */ "./src/app/components/user/login/login.component.ts");
/* harmony import */ var _muega_components_user_register_register_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @muega-components/user/register/register.component */ "./src/app/components/user/register/register.component.ts");
/* harmony import */ var _muega_services_authentication_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @muega-services/authentication.service */ "./src/app/services/authentication.service.ts");
/* harmony import */ var _muega_components_calendar_calendar_ctrl_calendar_ctrl_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @muega-components/calendar/calendar-ctrl/calendar-ctrl.component */ "./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.ts");
/* harmony import */ var _muega_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @muega-services/auth-guard.service */ "./src/app/services/auth-guard.service.ts");
/* harmony import */ var _muega_services_auth_interceptor__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @muega-services/auth-interceptor */ "./src/app/services/auth-interceptor.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'profile', component: _muega_components_user_profile_profile_component__WEBPACK_IMPORTED_MODULE_14__["ProfileComponent"], canActivate: [_muega_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_19__["AuthGuardService"]] },
    {
        path: '', component: _muega_components_calendar_calendar_component__WEBPACK_IMPORTED_MODULE_12__["CalendarComponent"], canActivate: [_muega_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_19__["AuthGuardService"]],
        children: [
            {
                path: '',
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _muega_components_calendars_calendars_component__WEBPACK_IMPORTED_MODULE_13__["CalendarsComponent"]
            ],
            imports: [
            ...
            exports: [_material_material_module__WEBPACK_IMPORTED_MODULE_7__["MaterialModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_8__["BrowserAnimationsModule"]],
            providers: [
                _muega_services_authentication_service__WEBPACK_IMPORTED_MODULE_17__["AuthenticationService"],
                _muega_services_auth_guard_service__WEBPACK_IMPORTED_MODULE_19__["AuthGuardService"],
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"],
                    useClass: _muega_services_auth_interceptor__WEBPACK_IMPORTED_MODULE_20__["AuthInterceptor"],
                    multi: true
                }
            ],
...
/***/ "./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.css":
/*!*******************************************************************************!*\
  !*** ./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.css ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.html":
/*!********************************************************************************!*\
  !*** ./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.html ***!
  \********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.ts":
/*!******************************************************************************!*\
  !*** ./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.ts ***!
  \******************************************************************************/
/*! exports provided: CalendarCtrlComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CalendarCtrlComponent", function() { return CalendarCtrlComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var CalendarCtrlComponent = /** @class */ (function () {
    function CalendarCtrlComponent() {
        this.view = 'month';
        this.viewDate = new Date();
        this.events = [];
    }
    CalendarCtrlComponent.prototype.ngOnInit = function () {
    };
    CalendarCtrlComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-calendar-ctrl',
            changeDetection: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectionStrategy"].OnPush,
            template: __webpack_require__(/*! ./calendar-ctrl.component.html */ "./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.html"),
            styles: [__webpack_require__(/*! ./calendar-ctrl.component.css */ "./src/app/components/calendar/calendar-ctrl/calendar-ctrl.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], CalendarCtrlComponent);
    return CalendarCtrlComponent;
}());
...
var CalendarComponent = /** @class */ (function () {
    function CalendarComponent(dateService, eventService, calendarService) {
    ...
    CalendarComponent.prototype.loadCalendar = function () {
        var _this = this;
        this.calendarService.getCalendars().subscribe(function (calendars) {
            calendars.forEach(function (element) {
                _this.calendars.set(element.name, element.color);
            });
            // console.log('calendarMap:', this.calendars);
            _this.loadEventsAsync();
        });
    };
    CalendarComponent.prototype.loadEventsAsync = function () {
        this.events$ = this.eventService.getEvents();
    };
    CalendarComponent.prototype.getCalendarEvents = function (events) {
        var _this = this;
    ...
    CalendarComponent.prototype.getColor = function (calendarName) {
        return this.calendars.get(calendarName);
    };
    CalendarComponent.prototype.addEvent = function (event) {
        this.calendarEvents.push({
            title: event.name,
            start: Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["startOfDay"])(event.startDateTime),
            end: Object(date_fns__WEBPACK_IMPORTED_MODULE_1__["endOfDay"])(event.endDateTime),
    ...
    CalendarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_muega_services_event_service__WEBPACK_IMPORTED_MODULE_2__["EventService"], _muega_services_calendar_service__WEBPACK_IMPORTED_MODULE_3__["CalendarService"], _muega_components_calendar_select_date_service__WEBPACK_IMPORTED_MODULE_4__["SelectDateService"]]
        }),
        __metadata("design:paramtypes", [_muega_components_calendar_select_date_service__WEBPACK_IMPORTED_MODULE_4__["SelectDateService"],
...
/***/ "./src/app/components/calendar/select-date.service.ts":
/*!************************************************************!*\
  !*** ./src/app/components/calendar/select-date.service.ts ***!
  \************************************************************/
/*! exports provided: SelectDateService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SelectDateService", function() { return SelectDateService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var SelectDateService = /** @class */ (function () {
    function SelectDateService() {
        this.date = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.date$ = this.date.asObservable();
    }
    SelectDateService.prototype.selectDate = function (date) {
        this.date.next(date);
    };
    SelectDateService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])({
            providedIn: 'root'
        })
    ], SelectDateService);
    return SelectDateService;
}());
...
/***/ "./src/app/components/calendars/calendars.component.css":
/*!**************************************************************!*\
  !*** ./src/app/components/calendars/calendars.component.css ***!
  \**************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/calendars/calendars.component.html":
/*!***************************************************************!*\
  !*** ./src/app/components/calendars/calendars.component.html ***!
  \***************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/calendars/calendars.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/components/calendars/calendars.component.ts ***!
  \*************************************************************/
...
var CalendarsComponent = /** @class */ (function () {
    ...
    CalendarsComponent.prototype.showNewCalendarCtrls = function () {
        this.newCalendar = { name: '', color: '#FFFFFF' };
        this.newCalendarVisible = true;
    };
    CalendarsComponent.prototype.delete = function (id) {
        var _this = this;
    ...
    CalendarsComponent.prototype.showEdit = function (id) {
        this.editId = id;
    };
    CalendarsComponent.prototype.cancelEdit = function () {
        this.editId = null;
        this.loadCalendars();
    };
    CalendarsComponent.prototype.saveEdit = function (calendar) {
        var _this = this;
    ...
    CalendarsComponent.prototype.cancelClick = function () {
        this.newCalendarVisible = false;
    };
    CalendarsComponent.prototype.saveClick = function () {
        var _this = this;
    ...
    CalendarsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./calendars.component.html */ "./src/app/components/calendars/calendars.component.html"),
            styles: [__webpack_require__(/*! ./calendars.component.css */ "./src/app/components/calendars/calendars.component.css")],
...
/***/ "./src/app/components/subscribers/subscribers.component.css":
/*!******************************************************************!*\
  !*** ./src/app/components/subscribers/subscribers.component.css ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/subscribers/subscribers.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/components/subscribers/subscribers.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "<br>\n<h2>Subscribers</h2>\n<br>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    \n    <table class=\"table\">\n      <thead>\n        <tr>\n          <th>Name</th>\n          <th>Calendars</th>\n          <th></th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor=\"let subscriber of subscribers\">\n          <td>{{subscriber.name}}</td>\n          <td>\n            <span *ngFor=\"let calendar of subscriber.calendars\">\n              <button mat-fab \n                style=\"width: 30px; height: 30px;\"\n                [style.background]=\"getCalendarColor(calendar)\">\n              </button>\n              &nbsp;\n            </span>\n          </td>\n          <td>\n            <button class=\"btn btn-sm btn-light\" routerLink=\"/subscribers/{{subscriber.name}}\" >\n              <mat-icon>edit</mat-icon>\n            </button>\n          </td>\n        </tr>\n      </tbody>\n    </table>\n  </div>\n</div>\n"

/***/ }),

/***/ "./src/app/components/subscribers/subscribers.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/components/subscribers/subscribers.component.ts ***!
  \*****************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _muega_services_subscriber_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @muega-services/subscriber.service */ "./src/app/services/subscriber.service.ts");
...
var SubscribersComponent = /** @class */ (function () {
    function SubscribersComponent(subscriberService, calendarService) {
    ...
    SubscribersComponent.prototype.ngOnInit = function () {
        ...
        this.calendarService.getCalendars()
            ...
            _this.loadSubscribers();
        });
    };
    SubscribersComponent.prototype.loadSubscribers = function () {
        var _this = this;
        this.subscriberService.getSubscribers().subscribe(function (subscribers) {
            console.log(subscribers);
            _this.subscribers = subscribers;
            console.log(_this.subscribers);
        });
    };
    SubscribersComponent.prototype.getCalendarColor = function (calendar) {
    ...
    SubscribersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./subscribers.component.html */ "./src/app/components/subscribers/subscribers.component.html"),
            styles: [__webpack_require__(/*! ./subscribers.component.css */ "./src/app/components/subscribers/subscribers.component.css")],
            providers: [_muega_services_subscriber_service__WEBPACK_IMPORTED_MODULE_1__["SubscriberService"], _muega_services_calendar_service__WEBPACK_IMPORTED_MODULE_2__["CalendarService"]]
        }),
        __metadata("design:paramtypes", [_muega_services_subscriber_service__WEBPACK_IMPORTED_MODULE_1__["SubscriberService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _muega_services_user_profile_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @muega-services/user-profile.service */ "./src/app/services/user-profile.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(userProfileSvc) {
    ...
    ProfileComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_muega_services_user_profile_service__WEBPACK_IMPORTED_MODULE_1__["UserProfileService"]])
    ], ProfileComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_AppConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/AppConstants */ "./src/app/shared/AppConstants.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthInterceptor = /** @class */ (function () {
    ...
    AuthInterceptor.prototype.intercept = function (req, next) {
        var token = localStorage.getItem(_shared_AppConstants__WEBPACK_IMPORTED_MODULE_1__["AppConstants"].tokenStorageKey);
        if (token) {
...
/* harmony import */ var _shared_AppConstants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/AppConstants */ "./src/app/shared/AppConstants.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, router) {
        this.http = http;
        this.router = router;
        this.tokenStorageKey = _shared_AppConstants__WEBPACK_IMPORTED_MODULE_5__["AppConstants"].tokenStorageKey;
    ...
    AuthenticationService.prototype.request = function (type, user) {
        var _this = this;
        var base = this.http.post(this.domain + "/api/" + type, user);
...
var CalendarService = /** @class */ (function () {
    ...
    CalendarService.prototype.getCalendars = function () {
        return this.http.get(this.domain + "/api/calendars");
    };
    CalendarService.prototype.addCalendar = function (newCalendar) {
        return this.http.post(this.domain + "/api/calendars", newCalendar);
    };
    CalendarService.prototype.deleteCalendar = function (id) {
        return this.http.delete(this.domain + "/api/calendars/" + id);
    };
    CalendarService.prototype.updateCalendar = function (newCalendar) {
        return this.http.put(this.domain + "/api/calendars/" + newCalendar._id, newCalendar);
    };
...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.getEvent = function (id) {
        return this.http.get(this.domain + "/api/events/" + id);
    };
    EventService.prototype.getEvents = function () {
        return this.http.get(this.domain + "/api/events");
    };
    EventService.prototype.getEventsByDate = function (date) {
        return this.http.get(this.domain + "/api/events/date/" + date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate());
    };
    EventService.prototype.addEvent = function (newEvent) {
        return this.http.post(this.domain + "/api/events", newEvent);
    };
    EventService.prototype.deleteEvent = function (id) {
        return this.http.delete(this.domain + "/api/events/" + id);
    };
    EventService.prototype.updateEvent = function (newEvent) {
        return this.http.put(this.domain + "/api/events/" + newEvent._id, newEvent);
    };
...
var SubscriberService = /** @class */ (function () {
    ...
    SubscriberService.prototype.getSubscribers = function () {
        return this.http.get(this.domain + "/api/subscribers");
    };
    SubscriberService.prototype.getSubscriberByName = function (name) {
        return this.http.get(this.domain + "/api/subscribers/byname/" + name);
    };
    SubscriberService.prototype.addSubscriber = function (newSubscriber) {
        return this.http.post(this.domain + "/api/subscribers", newSubscriber);
    };
    SubscriberService.prototype.deleteSubscriber = function (id) {
        return this.http.delete(this.domain + "/api/subscribers/" + id);
    };
    SubscriberService.prototype.updateSubscriber = function (newSubscriber) {
        return this.http.put(this.domain + "/api/subscribers/" + newSubscriber._id, newSubscriber);
    };
...
var UserProfileService = /** @class */ (function () {
    function UserProfileService(httpClient) {
        ...
        this.domain = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl;
    }
...
var AppConstants = /** @class */ (function () {
    ...
    AppConstants.tokenStorageKey = 'muega-api-token';
    return AppConstants;
}());
